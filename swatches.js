...
//Slightly minified
//Keeping this outside in case something else wants to use it
//Accepts HSV values from 0 to 1, not 0 to 100, so divide by 100
...
if (document.cookie.includes("swatches=experimental")) {
    ...
    addBr();
		addSwatch(0, 100, 100);
		addSwatch(12, 100, 100);
		addSwatch(15, 100, 100);
		addSwatch(40, 100, 100);
		addSwatch(60, 100, 100);
		addSwatch(73, 100, 100);
		addSwatch(80, 100, 100);
		//Rainbow colors
    addBr();
		addSwatch(0, 100, 100);
		addSwatch(8, 81, 100);
